	...
	var ListTests = []struct {
		...
		},
		{
			...
			ExpectedServers: []Server{{
				...
				Installed:  mustParseDate("12/11/2021"),
				IpAddress:  net.IPv4(142, 47, 89, 190),
				Netmask:    net.IPv4(255, 255, 255, 0),
				Gateway:    net.IPv4(142, 47, 89, 1),
				Password:   "UjWzrMRY7r",
				VmName:     "",
				CustomerId: 0,
				CurrentOs:  "Ubuntu 18.04 LTS 64bit",
				Ipv4:       net.IPv4(142, 47, 89, 190),
				Ipv6:       net.ParseIP("2607:8880::a000:11be"),
				Hostname:   "",
				CpuCount:   1,
				RamMB:      512,
				SsdGB:      10,
				...
				Status:     "Installing",
				Installed:  mustParseDate("12/11/2021"),
				IpAddress:  net.IPv4(142, 47, 89, 189),
				Netmask:    net.IPv4(255, 255, 255, 0),
				Gateway:    net.IPv4(142, 47, 89, 1),
				Password:   "PPYeQDLt8G",
				VmName:     "",
				CustomerId: 0,
				CurrentOs:  "Ubuntu 18.04 LTS 64bit",
				Ipv4:       net.IPv4(142, 47, 89, 189),
				Ipv6:       net.ParseIP("2607:8880::a000:11bd"),
				Hostname:   "",
				CpuCount:   1,
				RamMB:      512,
				SsdGB:      10,
